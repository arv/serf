...
export function TechsPage(): JSX.Element {
  return (
    <>
      <h1>Research</h1>
      <p class="lede">
        <Prose text="Studied at the Abbey, paid in goods first and time second. Ordering a study writes its bill on the Abbey and the serfs carry the goods there load by load, and the clock below starts only once the last one is in. Like a building site it is pegged out on credit, so a study can be ordered before the castle can pay for it. Three branches, and a tech waits on its prerequisites and nothing else." />
      </p>

...
const MODIFIER_LABEL: Record<ModifierKey, string> = {
  farmSpeed: 'Farms work',
  foodSpeed: 'The mill and the bakery work',
  forgeSpeed: 'The Smith works',
  mineSpeed: 'Mines work',
  serfSpeed: 'Serfs and workers walk',
  workSpeed: 'Everyone works',

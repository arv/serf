...
const BUILDING_FLAVOR: Partial<Record<BuildingTypeId, string>> = {
  ...
  guardTower:
    'Two archers man the roof, shooting half again as hard and two tiles further than they would on the ground. Man it and they walk in from the field on their own; until the village has any, villagers answer instead and hold it with stones — far weaker, but today rather than three techs from now. Standing it down empties the roof again and gives the men back. Nobody manning it can be shot at while the tower stands.',

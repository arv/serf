                  ...
                  <Show when={!def().storage}>
                    ...
                    <TipWrap
                      tip={() => (
                        <TextTip
                          title="Sell building"
                          body="Half the build cost, floored per good, or half of what a site was delivered, plus everything it held. Dropped as salvage. Frees the worker and any garrison."
                        />
                      )}
                    >
